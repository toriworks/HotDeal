...
//		Log.d("shp", "---->maximumPullScroll:" + maximumPullScroll + ", value:" + value);
	...
	protected final void smoothScrollTo(int scrollValue) {
		Log.d("shp", "smoothScrollTo:" + scrollValue);
	...
	private final void smoothScrollTo(int newScrollValue, long duration, long delayMillis,
		...
		Log.d("shp", "oldScrollValue:" + oldScrollValue + ", newScrollValue:" + newScrollValue);
